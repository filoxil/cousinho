	    ...
	    <tr><td colspan="2" align="center"><table width="900" border="0" align="center" cellpadding="0" cellspacing="0" style="margin:20px 0 20px 0">
		  ...
		  <tr>
			...
			<a href="condiciones_contratacion.php" class="link_rosa">Condiciones<br /> generales de<br /> contrataón</a>            </td>
...
function envia_mail(){
	...
	var nombre = $("#1_nombre").val();
	var email = $("#1_email").val();
	var consulta = $("#1_consulta").val();
	if (nombre =="" || email =="" || consulta ==""){
		alert('Por favor, rellena todos los campos para poderte contestar');	
	}else{
		$('#ayuda').load('blanco.html');
		$('#ayuda').load('envio_mail.php?n='+nombre+'&e='+email+'&c='+consulta);
	}
}
							...
							<tr><td align="right"><a href="javascript:muestra_ventana()" style=" text-decoration:none; color:#000000;">Cerrar</a></td></tr>
							  <tr>
								<td style="padding: 8px;">
								<span class= "desplegable_home_1"><strong>Llámale</strong></span><br>
								<span class= "desplegable_home_2">+34 655 12 80 11</span><br>
